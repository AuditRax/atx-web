        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden lg:flex items-center space-x-4">
              <a href="https://gativia.in" target="_blank" rel="noreferrer" className="bg-cyan-50 text-cyan-700 hover:bg-cyan-100 border border-cyan-100 px-5 py-2.5 rounded-xl text-sm font-bold transition shadow-sm inline-flex items-center justify-center gap-1.5">
                <Send className="w-4 h-4" /> Gativia</a>
          ...
          {mobileMenuOpen && (
            ...
            >
              ...
              <div className="pt-4 border-t border-gray-100 flex flex-col gap-3 px-4">
                <a href="https://gativia.in" target="_blank" rel="noreferrer" className="w-full bg-cyan-50 text-cyan-700 border border-cyan-100 text-center py-3 rounded-lg font-bold shadow-sm flex items-center justify-center gap-2">
                  <Send className="w-4 h-4" /> Gativia
                </a>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-gray-900 to-slate-800 rounded-3xl p-8 md:p-12 text-center text-white shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              <a href="https://gativia.in" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 bg-white text-gray-900 hover:bg-gray-100 px-8 py-3.5 rounded-xl font-bold transition-all shadow-lg hover:shadow-cyan-500/20">
...
/>
      ...
      {/* ===================== WHATSAPP WIDGET ===================== */}
      <a 
        href="https://wa.me/919082348560" 
        target="_blank" 
        rel="noreferrer"
        className="fixed bottom-8 right-8 bg-[#25D366] text-white flex items-center gap-3 px-3 py-2.5 pr-9 rounded-full shadow-[0_8px_24px_-6px_rgba(37,211,102,0.4)] z-[9999] transition-all hover:-translate-y-1 hover:shadow-[0_12px_28px_-6px_rgba(37,211,102,0.6)] no-underline"
      >
        <div className="bg-white text-[#25D366] w-10 h-10 rounded-full flex items-center justify-center">
        ...
        <div className="font-semibold text-[15px] font-sans tracking-tight">Chat with our expert</div>
      </a>
